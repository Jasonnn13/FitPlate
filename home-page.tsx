...
export default function HomePage({
  ...
  const { dailyStats, loading, error, refreshData } = useNutrition()

  // Refresh data when component mounts or when returning to home
  useEffect(() => {
    refreshData()
  }, [])
  ...
  const progressPercentage = stats.dailyGoal > 0 ? Math.min((stats.totalCalories / stats.dailyGoal) * 100, 100) : 0
        ...
        <div className="bg-[#f5f5f5] rounded-2xl p-6">
            ...
            <div className="flex-1">
              ...
              <div className="relative w-24 h-24 mb-4">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center">
                  {loading ? (
                    <span className="text-sm text-[#787880]">Loading...</span>
                  ) : error ? (
                    <span className="text-xs text-red-500">Error</span>
                  ) : (
                    <>
                      <span className="text-xl font-bold text-[#000000]">{stats.remaining}</span>
            ...
            <div className="space-y-4 text-sm">
              <div>
                ...
                <p className="text-[#000000] font-semibold">
                  {loading ? "..." : `${stats.totalCalories}/${stats.dailyGoal}`}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-[#000000] font-semibold">{loading ? "..." : stats.weeklyAverage}</p>
              </div>
              ...
              <div>
                ...
                <p className="text-[#000000] font-semibold">{loading ? "..." : stats.mealsConsumed}</p>
              </div>
            </div>
          </div>
          ...
          {error && (
            <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
              ...
              <button onClick={refreshData} className="text-red-700 text-sm underline mt-1">
                Try again
              </button>
            </div>
          )}
